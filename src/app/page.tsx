...
export default function LandingPage() {
 ...
 className="mx-auto max-w-[90rem] grid grid-cols-[1fr_auto_1fr] items-center bg-surface-0/90 backdrop-blur-md border border-surface-200 shadow-sm rounded-md px-3 py-2.5"
 >
 ...
 <Link href="/login" className="text-sm font-medium text-brand-500 hover:text-brand-400 transition-colors px-3 py-2">
 Log In
 </Link>
 <Link href="/register" className="btn-ember flex items-center gap-2 py-2.5 pl-5 pr-2 text-sm">
 <span>Sign Up</span>
 <span className="w-7 h-7 rounded-md bg-surface-0/20 flex items-center justify-center">
 ...
 className="fixed inset-0 z-40 bg-surface-50/95 backdrop-blur-md flex flex-col items-center justify-center gap-8"
 >
 ...
 Land your <br />
 <span className="font-display font-semibold text-ember-600">dream offer.</span>
 </h1>
 ...
 <section className="py-10 gridlines bg-surface-0/50">
 <div className="max-w-[90rem] mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 text-sm">
 <span className="font-display font-semibold text-2xl text-ember-600 text-brand-900">4 modules.</span>
 ...
 Everything you <span className="font-display font-semibold text-ember-600">need to win.</span>
 </h2>
 ...
 Ready to land <br />
 <span className="font-display font-semibold text-ember-600">your next role?</span>
 </h2>
 ...
 <a
 href="#features"
 className="text-sm font-medium text-brand-500 hover:text-brand-400 transition-colors px-5 py-2.5"
 >
 See how it works
 </a>
 </div>
