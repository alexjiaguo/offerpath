...
function MockInterviewContent({ jobId }: { jobId: string }) {
 ...
 className="p-1.5 rounded-lg text-surface-300 hover:text-surface-400 hover:bg-surface-0/[0.04] transition-all"
 >
 ...
 msg.role === "candidate"
 ? "bg-brand-600/30 border border-brand-500/20 text-surface-400"
 : "card-editorial text-surface-400"
 )}
 >
 ...
 <div className="card-editorial rounded-2xl px-4 py-3">
 <div className="flex items-center gap-1.5">
 <div className="w-2 h-2 rounded-full bg-surface-300 animate-pulse" />
 <div className="w-2 h-2 rounded-full bg-surface-300 animate-pulse" style={{ animationDelay: "0.2s" }} />
 <div className="w-2 h-2 rounded-full bg-surface-300 animate-pulse" style={{ animationDelay: "0.4s" }} />
 </div>
 </div>
 </div>
 )}
 ...
 {/* Input */}
 <div className="flex-shrink-0 card-editorial rounded-2xl p-3 flex items-end gap-3">
 <textarea
 value={userInput}
