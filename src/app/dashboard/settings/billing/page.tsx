...
export default function BillingPage() {
 ...
 <div>
 <p className="text-xs text-surface-300 uppercase tracking-wider mb-1">Current Plan</p>
 ...
 <span className={cn("font-medium", isNearLimit ? "text-amber-400" : "text-surface-400")}>
 ...
 >
 {plan.highlight && (
 <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-md bg-brand-500 text-[10px] font-bold text-white uppercase tracking-wider">
 Most Popular
 </div>
 )}
 ...
 isCurrent
 ? "bg-surface-200 text-surface-300 cursor-default"
 : plan.highlight
 ? "gradient-brand text-white hover:opacity-90"
 : "bg-surface-200 text-surface-400 hover:text-surface-400 hover:bg-surface-300"
 )}
 disabled={isCurrent}
 >
