...
export default function ApiKeysPage() {
 ...
 className="px-3 py-1.5 rounded-lg bg-surface-200/50 text-surface-300 hover:text-emerald-400 text-xs font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed min-w-[52px] flex items-center justify-center"
 >
 ...
 : "bg-surface-200 text-surface-300 hover:text-surface-400 border border-transparent"
 )}
 >
 ...
 className="px-4 py-2 rounded-xl bg-surface-200 text-surface-400 text-sm font-medium hover:text-surface-400 hover:bg-surface-300 transition-all"
 >
 Cancel
 </button>
 <button
 ...
 className="w-full py-4 rounded-2xl border-2 border-dashed border-white/[0.08] text-surface-300 hover:text-brand-400 hover:border-brand-500/30 transition-all flex items-center justify-center gap-2 text-sm font-medium"
 >
