...
export default function DiscoverJobDetailPage({
 ...
 "from-surface-300/20 to-surface-300/5";
 ...
 <span className="text-[10px] px-2 py-0.5 rounded-md bg-surface-200 text-surface-300 font-medium">
 {job.type}
 </span>
 <span className="text-[10px] px-2 py-0.5 rounded-md bg-surface-200 text-surface-300 font-medium flex items-center gap-1">
 ...
 <div className="flex items-center gap-4 text-sm text-surface-300 flex-wrap mt-2">
 <span className="flex items-center gap-1.5 font-medium text-surface-400">
 ...
 <div className="text-[9px] text-surface-300 uppercase">Match</div>
 </div>
 </div>
 ...
 target="_blank"
 rel="noopener"
 className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium bg-surface-200 text-surface-300 hover:text-blue-400 hover:bg-blue-500/10 transition-all"
 >
 ...
 {/* Description */}
 <div className="card-editorial rounded-xl p-5">
 ...
 <span className="text-2xl">{company.logo_emoji || company.name.charAt(0)}</span>
 <div>
 <div className="font-medium text-sm">{company.name}</div>
 <div className="text-surface-300">{company.industry}</div>
 </div>
 </div>
 ...
 <p className="text-surface-300 leading-relaxed">{company.notes}</p>
 <div className="flex flex-wrap gap-1.5">
 {company.tags.map((tag) => (
 <span key={tag} className="text-[10px] px-1.5 py-0.5 rounded bg-surface-200 text-surface-300">{tag}</span>
 ))}
 </div>
 <a
 ...
 <div className="flex items-center gap-2 text-[10px] text-surface-300 mt-1">
 ...
 <div className="card-editorial rounded-xl p-5 border border-brand-500/20">
