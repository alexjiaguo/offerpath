...
function NewResumeContent() {
 ...
 <div>
 <h1 className="text-4xl font-bold text-surface-400 font-display tracking-tight">Create New Resume</h1>
 <p className="text-surface-300 mt-2">Choose how you would like to start building your resume.</p>
 </div>
 ...
 <h3 className="text-xl font-bold text-surface-400 font-display mb-2">Import Existing Resume</h3>
 ...
 <h3 className="text-xl font-bold text-surface-400 font-display mb-2">Start from Scratch</h3>
 <p className="text-surface-300 text-sm leading-relaxed mb-8">
 ...
 <h2 className="text-2xl font-bold text-surface-400 font-display mb-3">Upload Your Resume</h2>
 ...
 <h2 className="text-2xl font-bold text-surface-400 font-display mb-3">Parsing Resume...</h2>
...
export default function NewResumePage() {
 return (
 <Suspense fallback={<div className="p-12 text-center text-surface-300 uppercase tracking-widest text-xs font-bold">Syncing...</div>}>
 <NewResumeContent />
 </Suspense>
 );
}
