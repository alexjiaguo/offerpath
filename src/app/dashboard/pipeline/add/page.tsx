...
export default function AddJobPage() {
 ...
 <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-300" />
 <input
 type="text"
 value={form.title}
 onChange={(e) => updateField("title", e.target.value)}
 placeholder="Senior Product Manager"
 className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-surface-100 border border-surface-200 text-sm focus:outline-none focus:border-brand-500/40 focus:ring-1 focus:ring-brand-500/20"
 />
 </div>
 ...
 <div className="relative">
 <Buildings className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-300" />
 <input
 type="text"
 ...
 <div className="relative">
 <Globe className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-300" />
 <input
 type="url"
 ...
 <div className="relative">
 <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-300" />
 <input
 type="text"
 value={form.location}
 ...
 <div className="relative">
 <Coins className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-300" />
 <input
 type="text"
 ...
 className="w-full px-4 py-2.5 rounded-lg bg-surface-100 border border-surface-200 text-sm focus:outline-none focus:border-brand-500/40 focus:ring-1 focus:ring-brand-500/20"
 />
 </div>
 ...
 : "bg-surface-100 text-surface-300 border border-transparent hover:text-surface-400"
 }`}
 >
 T{t}
 </button>
 ...
 className="w-full px-3 py-2.5 rounded-lg bg-surface-100 border border-surface-200 text-sm focus:outline-none focus:border-brand-500/40"
 >
 {JOB_LEVELS.map((l) => (
 ...
 rows={6}
 className="w-full px-4 py-3 rounded-lg bg-surface-100 border border-surface-200 text-sm resize-none focus:outline-none focus:border-brand-500/40 focus:ring-1 focus:ring-brand-500/20"
 />
 </div>
 ...
 <Link
 href="/dashboard/pipeline"
 className="px-4 py-2 rounded-lg text-sm font-medium hover:bg-surface-100 transition-colors"
 >
 Cancel
 </Link>
 <button
