  ...
  return (
    <>
      ...
      <div className="space-y-3 mb-6">
        <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-surface-200 border border-zinc-200 dark:border-white/[0.06] text-sm font-medium text-zinc-700 dark:text-gray-300 hover:text-zinc-900 dark:hover:text-white hover:bg-surface-300 transition-all">
