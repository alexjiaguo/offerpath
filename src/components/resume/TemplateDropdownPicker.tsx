  ...
  return (
    <div className="relative flex-1 min-w-[120px]" ref={containerRef}>
      <button
        ...
        className="w-full flex items-center justify-between bg-surface-50 border border-surface-200 text-surface-400 px-2 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider cursor-pointer focus:outline-none hover:bg-surface-100 transition-all truncate"
      >
      ...
      {open && (
        <div className="absolute z-50 top-full left-0 mt-2 w-[340px] bg-white border border-surface-200 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] p-3 animate-reveal-up max-h-[450px] overflow-y-auto">
