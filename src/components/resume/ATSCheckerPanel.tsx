...
export default function ATSCheckerPanel({ resumeData }: ATSCheckerPanelProps) {
 ...
 <span className="block text-[11px] font-bold uppercase tracking-wide truncate text-surface-400">ATS Intelligence</span>
 ...
 <h2 className="text-base font-bold text-surface-400 uppercase tracking-widest">ATS Intelligence</h2>
 </div>
 <button
 onClick={() => setShowModal(false)}
