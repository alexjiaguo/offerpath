...
export default function RichTextEditor({
 ...
 attributes: {
 class:
 "prose prose-sm max-w-none min-h-[400px] px-5 py-4 focus:outline-none text-surface-400 leading-relaxed [&_h1]:text-xl [&_h1]:font-bold [&_h1]:mb-3 [&_h1]:text-surface-400 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mb-2 [&_h2]:text-surface-400 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:mb-2 [&_p]:mb-2 [&_ul]:pl-5 [&_ol]:pl-5 [&_li]:mb-1 [&_blockquote]:border-l-2 [&_blockquote]:border-brand-500/40 [&_blockquote]:pl-4 [&_blockquote]:text-surface-300 [&_hr]:border-black/10 [&_mark]:bg-yellow-200 [&_mark]:rounded [&_mark]:px-0.5",
 },
 },
 onUpdate: ({ editor }) => {
 ...
 <div className="relative group">
 <span
 className="inline-flex items-center justify-center w-8 h-8 rounded-md text-surface-300"
 title="Text Color"
 >
 ...
 {/* Word count footer */}
 <div className="px-4 py-2 border-t border-border flex items-center justify-between text-[10px] text-surface-300">
 <span>
