...
export default function ThemePicker({ theme, onChange, preview }: ThemePickerProps) {
 ...
 className="group flex-1 flex items-center justify-between gap-2 rounded-lg border border-surface-200 bg-surface-0 px-2.5 py-1.5 text-left transition-all hover:border-brand-500/30 hover:bg-surface-100/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40 min-w-0"
 >
 ...
 <span className="text-xs font-bold uppercase tracking-wider truncate text-surface-400">Visual DNA</span>
 </div>
 ...
 <h2 className="text-base font-bold text-surface-400 uppercase tracking-widest">Visual DNA</h2>
 </div>
 <button
 onClick={() => setShowModal(false)}
 ...
 <Check className="w-4 h-4 text-surface-400" strokeWidth={3} />
 </div>
 )}
 </button>
 );
 ...
 <label className="text-[9px] font-bold text-surface-300 uppercase tracking-widest block ml-1">Primary Spectrum</label>
 <div className="flex items-center gap-2">
 ...
 <div className="space-y-2">
 <label className="text-[9px] font-bold text-surface-300 uppercase tracking-widest block ml-1">Accent Spectrum</label>
 <div className="flex items-center gap-2">
 ...
 <div className="space-y-3">
 <label className="text-[9px] font-bold text-surface-300 uppercase tracking-widest block ml-1">Core Size</label>
 <div className="flex items-center gap-3">
 ...
 <div className="space-y-3">
 <label className="text-[9px] font-bold text-surface-300 uppercase tracking-widest block ml-1">Flow Height</label>
 <div className="flex items-center gap-3">
 ...
 {/* Right: live preview */}
 {preview && (
 <div className="rounded-2xl bg-surface-50 border border-surface-200 p-4 overflow-hidden flex items-start justify-center md:sticky md:top-24 md:self-start md:max-h-[70vh] md:overflow-y-auto">
