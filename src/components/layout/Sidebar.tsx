        ...
        >
          {collapsed ? (
            ...
            <div className="flex items-center justify-between w-full px-2.5">
              <span className="text-[10px] font-mono font-medium uppercase tracking-[0.15em]">{t.nav.collapse}</span>
        ...
        >
          {collapsed ? (
            ...
            <div className="flex items-center gap-2.5 px-2.5 w-full text-left">
              ...
              <span className="text-[12px] font-medium tracking-tight">{t.nav.signOut}</span>
            </div>
          )}
        </button>
      </div>
