    ...
    <header className="h-14 flex items-center justify-between px-4 md:px-6 bg-surface-0/90 backdrop-blur-md border-b border-surface-200 sticky top-0 z-30 flex-shrink-0">
      ...
      <div className="flex items-center gap-3 ml-4">
        ...
        <motion.button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-surface-400 text-surface-0 hover:bg-[#2A2A2A] text-xs font-semibold uppercase tracking-wider transition-all active:scale-[0.98]"
        >
        ...
        {/* Notifications */}
        <button 
          className="w-8 h-8 flex items-center justify-center rounded-md border border-surface-200 bg-surface-0 text-surface-300 hover:text-surface-400 hover:bg-surface-100 transition-all" 
          aria-label="Notifications"
        >
          <Bell weight="regular" className="w-4 h-4" />
        </button>
        ...
        >
          ...
          <div className="hidden lg:block text-left">
            <div className="text-[11px] font-mono font-semibold tracking-tight text-surface-400 leading-none">Demo User</div>
          </div>
        </Link>
      </div>
    </header>
