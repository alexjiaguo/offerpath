...
export default function ResumePicker() {
 ...
 <>
 {" "}at{" "}
 <span className="text-surface-400">{job.company.name}</span>
 </>
 )}
 </p>
 </div>
 ...
 <p className="text-sm text-surface-300">No resumes yet</p>
 ...
 >
 {isSelected && <Check className="w-3 h-3 text-surface-400" />}
 </div>
 ...
 <p className="text-sm font-medium text-surface-400 truncate">
 {resume.title}
 </p>
 ...
 <button
 onClick={handleSkip}
 className="text-sm text-surface-300 hover:text-surface-400 transition-colors"
 >
 Skip for now
 </button>
