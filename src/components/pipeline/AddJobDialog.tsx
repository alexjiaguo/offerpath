...
export default function AddJobDialog() {
 ...
 <span className="text-xs text-surface-300 ml-1">/ 5.0</span>
 </div>
 <span
 className={cn(
 ...
 <span className="px-2 py-0.5 rounded-md text-xs text-surface-300 bg-surface-200">
 {evaluation.archetype}
 </span>
 </div>
 <p className="text-xs text-surface-300">{evaluation.match_summary}</p>
 </div>
 )}
 </div>
