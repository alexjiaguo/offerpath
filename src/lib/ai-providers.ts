/* ═══════════════════════════════════════════════════
   Server-side AI provider utilities — extracted from
   src/app/api/ai/route.ts because Next.js route files
...
export async function serverValidateApiKey(provider: string, apiKey: string): Promise<{ valid: boolean; error?: string }> {
